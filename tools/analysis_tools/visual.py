...
if __name__ == '__main__':
    ...
    results = mmcv.load('test/mv2d_r50_frcnn_two_frames_1408x512_ep72/Sun_Dec__7_17_39_54_2025/pts_bbox/results_nusc.json')
    sample_token_list = list(results['results'].keys())
    for id in range(0, 6008):
        render_sample_data(sample_token_list[id], pred_data=results, out_path='test/mv2d_r50_frcnn_two_frames_1408x512_ep72/Sun_Dec__7_17_39_54_2025/vis/' + sample_token_list[id])
