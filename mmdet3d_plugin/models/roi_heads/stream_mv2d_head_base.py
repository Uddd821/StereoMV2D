...
from .utils.hybrid_query_generator import HybridQueryGenerator


@HEADS.register_module()
class SteamMV2DHeadBase(BaseRoIHead, BBoxTestMixin, MaskTestMixin):
    def __init__(self,
                 bbox_roi_extractor,
                 bbox_head,
                 query_generator,
                 ...
                 test_cfg=None,
                 **kwargs):
        super(SteamMV2DHeadBase, self).__init__(bbox_roi_extractor=bbox_roi_extractor, bbox_head=bbox_head,
        ...
        self.query_generator = HybridQueryGenerator(**query_generator)
    ...
    def get_box_params(self, bboxes, intrinsics, extrinsics):
        ...
        for img_id, (bbox, intrinsic, extrinsic) in enumerate(zip(bboxes, intrinsics, extrinsics)):
            ...
            intrinsic_list.append(intrinsic) # equivalent camera intrinsic matrix
    ...
    def _bbox_forward_train(self, x, proposal_list, cur_img_metas, **data):
        """Run forward function and calculate loss for box head in training."""

        bbox_results = self._bbox_forward(x, proposal_list, cur_img_metas, **data)
    ...
    def simple_test(self, x, proposal_list, img_metas, rescale=False, **data):
        ...
        results_from_last = self._bbox_forward(x, proposal_list, img_metas, **data)
