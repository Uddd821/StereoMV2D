...
class StreamNuScenesDataset(NuScenesDataset):
    ...
    def __init__(self,
        ...
        super(StreamNuScenesDataset, self).__init__(**kwargs)
    ...
    def __len__(self):
        return super(StreamNuScenesDataset, self).__len__()
    ...
    def union2one(self, queue):
        ...
        if not self.test_mode:
            for key in ['gt_bboxes_2d', 'gt_labels_2d']: # , 'gt_bboxes_2d_to_3d', 'gt_bboxes_ignore'
    ...
    def get_data_info(self, index):
        ...
        if not self.test_mode: # for seq_mode
            ...
            prev_exists = not (index == 0 or self.flag[index - 1] != self.flag[index]) # None
